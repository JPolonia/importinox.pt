	...
	<tbody>
																						...
																						<tbody>
																							<tr>
																								...
																								<td width="100" align="center"> 
																									<a class="submenu_off" href="nm_registo.php?gam=CPF" ><?php if($gama=="CPF"){  ?> <b>Chapa Perfurada</b><?php } else { ?> Chapa Perfurada	<?php } ?></a>
																								</td>
																								<td width="100" align="center">
																									<a class="submenu_off" href="nm_registo.php?gam=FIX&gru=AFS"><?php if($gama=="FIX") { ?><b>Fixação</b><?php } else { ?>Fixação</a><?php } ?> 
																								</td>
																								
																								<td width="100" align="center">
																									<a class="submenu_off" href="nm_registo.php?gam=MET"><?php if($gama=="MET") { ?><b>Metal Distendido</b><?php } else{ ?>Metal Distendido</a><?php } ?> 
																								</td>
																								<td width="100" align="center">
																									<a class="submenu_off" href="nm_registo.php?gam=GRA"><?php if($gama=="GRA") { ?><b>Gradil</b><?php } else{ ?>Gradil</a><?php } ?> 
																								</td>
																								<td width="100" align="center">
																									<a class="submenu_off" href="nm_registo.php?gam=OUT&gru="><?php if($gama=="OUT") { ?><b>Outros</b><?php } else { ?>Outros</a><?php } ?> 
																								</td>
																							</tr>
		...
		<tr>
			...
			<td style="PADDING-TOP: 10px">
				...
				<br>
							<!--
								<div id="flashContent" align="middle">
									<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="710" height="280" id="Flash" align="middle">
										...
										<!--[if !IE]>-->
										<!--
										<object type="application/x-shockwave-flash" data="Flash.swf" width="710" height="280">
											<param name="movie" value="Flash.swf" />
											<param name="quality" value="high" />
											<param name="bgcolor" value="#ffffff" />
											<param name="play" value="true" />
				...
				<div id="flashContent" align="middle" border="20">
					<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="700" height="400" id="galeria" align="middle">
						...
						<param name="allowScriptAccess" value="sameDomain" />
						<!--[if !IE]>-->
						<object type="application/x-shockwave-flash" data="galeria.swf" width="700" height="400">
							<param name="movie" value="galeria.swf" />
							<param name="quality" value="high" />
							<param name="bgcolor" value="#ffffff" />
							<param name="play" value="true" />
...
oCMenu.makeMenu('top4','','<div style="height:46px; margin-top:15px; ">Aplicações</div>','nm_registo.php','', '191.5','','','','clLevel0_selected','clLevel0_selectedover')
